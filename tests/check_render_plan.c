...
START_TEST (render_simple_plan)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 73);
    ck_assert(result == 0);
    fflush(memstream);
...
START_TEST (render_narrow_plan)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 61);
    ck_assert(result == 0);
    fflush(memstream);
...
START_TEST (render_undersized_plan)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 60);
    ck_assert(result == 0);
    fflush(memstream);
...
START_TEST (render_very_undersized_plan)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 50);
    ck_assert(result == 0);
    fflush(memstream);
...
START_TEST (render_vvery_undersized_plan)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 38);
    ck_assert(result == 0);
    fflush(memstream);
...
START_TEST (render_vvvery_undersized_plan)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 21);
    ck_assert(result == 0);
    fflush(memstream);
...
START_TEST (render_simple_profile)
{
    ...
    int result = neo4j_render_plan_table(memstream, plan, 78);
    ck_assert(result == 0);
    fflush(memstream);
